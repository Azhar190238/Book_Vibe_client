        ...
        <div className='mt-10'>
            ...
            {<div className="md:card md:card-side md:bg-base-100  shadow-xl">
                ...
                <div className="card-body">
                    ...
                    <div className='flex gap-2 md:gap-10   md:text-xl md:font-semibold text-[#23BE0A]'>
                        ...
                        <div className='flex mt-5 mb-4 md:gap-8'>
                        ...
                        <div className='flex gap-2 md:gap-10  mb-5 md:text-xl font-semibold'>

                        <h1 className='bg-slate-100 px-2 md:px-6 py-2  text-[#328EFF] rounded-2xl'>Category: <span>{category}</span></h1>
